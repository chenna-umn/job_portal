    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <?php if(Yii::app()->user->hasFlash('error')){?>
                    ...
                    <?php } ?>
                 <div class="row margin-bottom-10">                          
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/create';?>"><button type="button" class="btn-u btn-u-orange">Add New Sub Category</button></a>  
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/index';?>"><button type="button" class="btn-u">List All Sub Categories</button></a>   
                    </div>
                <div class="profile-body">
                    <!--Service Block v3-->
                    <div class="row margin-bottom-10">                       
                        <div class="col-md-10 bg-orange">
                        <form action="<?php echo Yii::app()->request->baseUrl.'/Subcategory/createMultiple';?>" class="sky-form bg-cyan" method="post">
				<header>Add Bulk Sub Categories</header>
				...
				<fieldset>
					...
					<section>
						...
						<label class="textarea textarea-resizable">
							<textarea rows="10" name="Subcategory[name]" required></textarea>
						</label>
					</section>
				</fieldset>
