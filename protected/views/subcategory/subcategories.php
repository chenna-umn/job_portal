    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <?php } ?>
                    <div class="row margin-bottom-10">                      
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/index';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-purple">Total Sub Categories : <?php echo Subcategory::model()->recordCount('all');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/SubCategoriesByStatus?field=status&value=active';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-sea">Active Sub Categories : <?php echo Subcategory::model()->recordCount('active');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/SubCategoriesByStatus?field=status&value=inactive';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-default">In Active Sub Categories : <?php echo Subcategory::model()->recordCount('inactive');?></button></a> 
                        
                    </div>
                    <div class="row margin-bottom-10"> 
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/create';?>"><button type="button" class="btn-u">Add New Sub Category</button></a>     
                        </div>
                          <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/createMultiple';?>"><button type="button" class="btn-u btn-u-orange">Add Multi Sub Categories</button></a>  
                        </div>                       
                        
                        <div class="col-md-6">
                            <div class="input-group">
                            <form action="<?php echo Yii::app()->request->baseUrl.'/Subcategory/SubCategoriesByStatus';?>" method="get">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="record<?php echo $model['id'];?>">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo Yii::app()->request->baseUrl.'/Subcategory/update?id='.$model['id'];?>" target="_blank"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                if($model['status']==1){?>
                                                     ...
                                                     <?php } }else{ ?>
                                                         <div class="alert alert-info fade in">
                                                            <strong>Oops!</strong> Currently there are no Sub Category exists.
                                                        </div>
                                                   <?php  }
                                                     ?>
                                                </tbody>
    ...
    <script>
        function deleteRecord(recordId){
            ...
            var baseurl = "<?php echo Yii::app()->request->baseUrl;?>";           
                if (message == true) {                   
                     jQuery.ajax({                            
                            url: baseurl+'/Subcategory/delete',
                            type: "POST",
                            data: {id: recordId},  
                            error: function(){
        ...
        function makeStatusRecord(recordId,status){
            ...
            var currentstatus = document.getElementById('hiddenmakestatus'+recordId).value;           
                if (message == true) {                   
                     jQuery.ajax({                            
                            url: baseurl+'/Subcategory/MakeStatus',
                            type: "POST",
                            data: {id: recordId},  
                            error: function(){
                                     alert("Something Went Wrong...Please Try Later.");
        ...
        function searchBy(id){
            var baseurl = "<?php echo Yii::app()->request->baseUrl;?>"; 
            var url = baseurl+'/Subcategory/SearchByCategory?id='+id;
            window.location = url;
