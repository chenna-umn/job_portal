    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <?php } ?>
                    <div class="row margin-bottom-10">                      
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Company/index';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-purple">Total Records : <?php echo Company::model()->recordCount('all');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Company/CompanyByStatus?field=status&value=active';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-sea">Active Records : <?php echo Company::model()->recordCount('active');?></button></a> 
                      <a href="<?php echo Yii::app()->request->baseUrl.'/Company/CompanyByStatus?field=status&value=inactive';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-default">In Active Records : <?php echo Company::model()->recordCount('inactive');?></button></a> 
                        
                    </div>
                    <div class="row margin-bottom-10"> 
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Company/create';?>"><button type="button" class="btn-u">Add New Company</button></a>     
                        </div>
                          <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Company/createMultiple';?>"><button type="button" class="btn-u btn-u-orange">Add Multi Companies</button></a>  
                        </div>
                        
                        
                        <div class="col-md-6">
                            <div class="input-group">
                            <form action="<?php echo Yii::app()->request->baseUrl.'/Company/CompanyByStatus';?>" method="get">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="record<?php echo $model['id'];?>">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo Yii::app()->request->baseUrl.'/Company/update?id='.$model['id'];?>" target="_blank"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                if($model['status']==1){?>
    ...
    <script>
        ...
        function makeStatusRecord(recordId,status){
            ...
            var currentstatus = document.getElementById('hiddenmakestatus'+recordId).value;           
                if (message == true) {                   
                     jQuery.ajax({                            
                            url: baseurl+'/Company/MakeStatus',
                            type: "POST",
                            data: {id: recordId},  
                            error: function(){
                                     alert("Something Went Wrong...Please Try Later.");
