    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <div class="row margin-bottom-10"> 
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/City/create';?>"><button type="button" class="btn-u">Add New State</button></a>     
                        </div>
                          <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/City/createMultiple';?>"><button type="button" class="btn-u btn-u-orange">Add Multi States</button></a>  
                        </div>                       
