    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <?php if(Yii::app()->user->hasFlash('error')){?>
                    ...
                    <?php } ?>
                 <div class="row margin-bottom-10">                          
                        <a href="<?php echo Yii::app()->request->baseUrl.'/City/create';?>"><button type="button" class="btn-u btn-u-orange">Add New City</button></a>  
                ...
                <div class="profile-body">
                    ...
                    <div class="row margin-bottom-10">                       
                        ...
                        <form action="<?php echo Yii::app()->request->baseUrl.'/City/createMultiple';?>" class="sky-form bg-cyan" method="post">
				<header>Add Bulk Cities</header>
				...
				<fieldset>
					...
					<section>
						...
						<label class="textarea textarea-resizable">
							<textarea rows="10" name="City[name]" required></textarea>
						</label>
					</section>
				</fieldset>
