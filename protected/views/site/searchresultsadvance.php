             ...
             <div class="col-md-9" id="records">               
                ...
                <div class="inner-results">
                    ...
                    <div class="col-md-7" style="padding-left: 5px; padding-right: 5px;">
                        <a href="<?php echo Yii::app()->request->baseUrl . '/upsrf-'.User::model()->seoFriendlyUrl($value['jobtitle']).'-' . $value['id'].'.htm'; ?>" style="color:#555;" target="_blank"><?php echo $value['jobtitle']; ?></a>
                    </div>
                    <div class="col-md-2" style="padding-left: 5px; padding-right: 5px;">
