    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <?php } ?>
                    <div class="row margin-bottom-10">                      
                        <a href="<?php echo Yii::app()->request->scriptUrl.'/State/index';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-purple">Total Sub States : <?php echo State::model()->recordCount('all');?></button></a> 
                        <a href="<?php echo Yii::app()->request->scriptUrl.'/State/StateByStatus?field=status&value=active';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-sea">Active Sub States : <?php echo State::model()->recordCount('active');?></button></a> 
                        <a href="<?php echo Yii::app()->request->scriptUrl.'/State/StateByStatus?field=status&value=inactive';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-default">In Active Sub States : <?php echo State::model()->recordCount('inactive');?></button></a> 
                        
                    </div>
                    <div class="row margin-bottom-10"> 
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->scriptUrl.'/State/create';?>"><button type="button" class="btn-u">Add New State</button></a>     
                        </div>
                          <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->scriptUrl.'/State/createMultiple';?>"><button type="button" class="btn-u btn-u-orange">Add Multi States</button></a>  
                        </div>                       
                        
                        <div class="col-md-6">
                            <div class="input-group">
                            <form action="<?php echo Yii::app()->request->scriptUrl.'/State/StateByStatus';?>" method="get">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="record<?php echo $model['id'];?>">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo Yii::app()->request->scriptUrl.'/State/update?id='.$model['id'];?>" target="_blank"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                if($model['status']==1){?>
                                                     ...
                                                     <?php } }else{ ?>
                                                         <div class="alert alert-info fade in">
                                                            <strong>Oops!</strong> Currently there are no State exists.
                                                        </div>
                                                   <?php  }
                                                     ?>
                                                </tbody>
    ...
    <script>
        function deleteRecord(recordId){
            ...
            var baseurl = "<?php echo Yii::app()->request->scriptUrl;?>";           
                if (message == true) {                   
                     jQuery.ajax({                            
        ...
        function searchBy(id){
            var baseurl = "<?php echo Yii::app()->request->scriptUrl;?>"; 
            var url = baseurl+'/State/SearchByCountry?id='+id;
            window.location = url;
