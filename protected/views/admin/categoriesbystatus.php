    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <?php } ?>
                     <div class="row margin-bottom-10">                      
                        <a href="<?php echo Yii::app()->request->baseUrl.'/admin/categories';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-purple">Total Categories : <?php echo Category::model()->recordCount('all');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/admin/CategoriesByStatus?field=status&value=active';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-sea">Active Categories : <?php echo Category::model()->recordCount('active');?></button></a> 
                      <a href="<?php echo Yii::app()->request->baseUrl.'/admin/CategoriesByStatus?field=status&value=inactive';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-default">In Active Categories : <?php echo Category::model()->recordCount('inactive');?></button></a> 
                        
                    </div>
                    <div class="row margin-bottom-10">  
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/admin/create';?>"><button type="button" class="btn-u">Add New Category</button></a>     
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="<?php echo Yii::app()->request->baseUrl.'/admin/CategoriesByStatus';?>" method="get">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="record<?php echo $model['id'];?>">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo Yii::app()->request->baseUrl.'/admin/update?id='.$model['id'];?>" target="_blank"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                if($model['status']==1){?>
