    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    <!--Service Block v3-->
                    <div class="row margin-bottom-10">
                        <a href="<?php echo Yii::app()->request->baseUrl.'/admin/categories';?>"><button type="button" class="btn-u btn-u-dark-blue">List All Category</button></a>                        
                    </div>
                    <div class="row margin-bottom-10">                       
                        <div class="col-md-8 bg-cyan">
                        <form action="<?php echo Yii::app()->request->baseUrl.'/admin/update?id='.$model->id;?>" class="sky-form bg-cyan" method="post">
				...
				<fieldset>
					<section>
						...
						<label class="input">
							<input type="text" name="Category[name]" value="<?php echo $model->name;?>" required>
