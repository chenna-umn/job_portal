...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl.'/jp_assets/';?>assets/css/pages/page_job_inner1.css">
    <!-- CSS Customization -->
    ...
    <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl.'/jp_assets/';?>assets/js/md5.js"></script>
