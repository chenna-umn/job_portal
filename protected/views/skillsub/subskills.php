    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <?php } ?>
                    <div class="row margin-bottom-10">                      
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Skillsub/index';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-purple">Total Sub Skills : <?php echo Skillsub::model()->recordCount('all');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Skillsub/SubskillsByStatus?field=status&value=active';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-sea">Active Sub Skills : <?php echo Skillsub::model()->recordCount('active');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Skillsub/SubskillsByStatus?field=status&value=inactive';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-default">In Active Sub Skills : <?php echo Skillsub::model()->recordCount('inactive');?></button></a> 
                        
                    </div>
                    <div class="row margin-bottom-10"> 
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Skillsub/create';?>"><button type="button" class="btn-u">Add New Sub Skill</button></a>     
                        </div>
                          <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Skillsub/createMultiple';?>"><button type="button" class="btn-u btn-u-orange">Add Multi Sub Skills</button></a>  
                        </div>                       
                        
                        <div class="col-md-6">
                            <div class="input-group">
                            <form action="<?php echo Yii::app()->request->baseUrl.'/Skillsub/SubskillsByStatus';?>" method="get">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="record<?php echo $model['id'];?>">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo Yii::app()->request->baseUrl.'/Skillsub/update?id='.$model['id'];?>" target="_blank"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                if($model['status']==1){?>
    ...
    <script>
        ...
        function makeStatusRecord(recordId,status){
            ...
            var currentstatus = document.getElementById('hiddenmakestatus'+recordId).value;           
                if (message == true) {                   
                     jQuery.ajax({                            
                            url: baseurl+'/Skillsub/MakeStatus',
                            type: "POST",
                            data: {id: recordId},  
                            error: function(){
                                     alert("Something Went Wrong...Please Try Later.");
        ...
        function searchBy(id){
            var baseurl = "<?php echo Yii::app()->request->baseUrl;?>"; 
            var url = baseurl+'/Skillsub/SearchBySkill?id='+id;
            window.location = url;
