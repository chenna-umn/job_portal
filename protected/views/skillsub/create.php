            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <div class="row margin-bottom-10">                       
                        ...
                        <form action="<?php echo Yii::app()->request->baseUrl.'/Skillsub/create';?>" class="sky-form bg-cyan" method="post">
				...
				<fieldset>
					...
					<section>
						<label class="label">Sub Skill Name</label>
						<label class="input">
							<input type="text" name="Skillsub[name]" required>
