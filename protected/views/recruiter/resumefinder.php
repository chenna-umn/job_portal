    ...
    <div class="row" >
        ...
        <div class="col-md-10" style="background: #dedede;">
            ...
            <div class="row margin-bottom-40" style="padding-top: 20px;">
                <form action="<?php echo Yii::app()->request->baseUrl . '/Recruiter/resumeFeed'; ?>" id="sky-form4" class="sky-form" method="post">
                    <div class="col-md-6">
                        <!-- Reg-Form -->
                        ...
                        <fieldset>                  
                            ...
                            <section>
                                ...
                                <label class="input">
                                    ...
                                    <input type="text" name="Resumefinder[name]" placeholder="Name" class="invalid" required>
...
<?php } ?>								
                            ...
                            <footer>
                                <button class="btn-u btn-u-lg btn-u-purple" type="submit">Save & Search</button>    
