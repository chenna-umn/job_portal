    	...
    	<div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="profile-body">
                    ...
                    <?php } ?>
                     <div class="row margin-bottom-10">                      
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Degree/index';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-purple">Total Records : <?php echo Degree::model()->recordCount('all');?></button></a> 
                        <a href="<?php echo Yii::app()->request->baseUrl.'/Degree/DegreeByStatus?field=status&value=active';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-sea">Active Records : <?php echo Degree::model()->recordCount('active');?></button></a> 
                      <a href="<?php echo Yii::app()->request->baseUrl.'/Degree/DegreeByStatus?field=status&value=inactive';?>"><button type="button" class="btn-u btn-u-lg rounded-4x btn-u-default">In Active Records : <?php echo Degree::model()->recordCount('inactive');?></button></a> 
                        
                    </div>
                    <div class="row margin-bottom-10">  
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Degree/create';?>"><button type="button" class="btn-u">Add New Degree</button></a>     
                        </div>
                        <div class="col-md-3">
                            <a href="<?php echo Yii::app()->request->baseUrl.'/Degree/createMultiple';?>"><button type="button" class="btn-u btn-u-orange">Add Multi Companies</button></a> 
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                            <form action="<?php echo Yii::app()->request->baseUrl.'/Degree/DegreeByStatus';?>" method="get">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr id="record<?php echo $model['id'];?>">
                                                        ...
                                                        <td>
                                                            <a href="<?php echo Yii::app()->request->baseUrl.'/Degree/update?id='.$model['id'];?>" target="_blank"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                        <td>
                                                            <?php 
                                                                if($model['status']==1){?>
                                                     ...
                                                     <?php } }else{ ?>
                                                         <div class="alert alert-info fade in">
                                                            <strong>Oops!</strong> Currently there are no Degree exists.
                                                        </div>
                                                   <?php  }
                                                     ?>
                                                </tbody>
